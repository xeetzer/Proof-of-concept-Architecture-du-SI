 ...
 * 
 */
@WebFault(name = "IOException", targetNamespace = "http://webservice.correction.servicenotaire.hegarc.ch/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: ch.hegarc.servicenotaire.correction.webservice.IOException
     */
